...
**File: `apps/erp/backend/tests/unit/test_db_constraints.py`**
...
**File: `apps/erp/backend/tests/unit/test_db_sequences.py`**
...
**File: `apps/erp/backend/tests/unit/test_conditional_updates.py`**
...
**File: `apps/erp/backend/tests/unit/test_select_for_update.py`**
- (Integration level — see below)

**File: `apps/erp/backend/tests/unit/test_idempotency.py`**
- Test idempotency key rejection on duplicate
- Test TTL cleanup
- Test response replay

**File: `apps/erp/backend/tests/unit/test_logging.py`**
- Test logger.error is called for F01 scenario
- Test logger.error is called for F02 scenario
- Test commit→flush replacements

**File: `apps/erp/backend/tests/unit/test_csrf.py`**
- Test CSRF rejection without token
- Test CSRF pass with valid token

**File: `apps/erp/backend/tests/unit/test_rate_limit.py`**
- Test rate limit enforcement
- Test X-Forwarded-For parsing

### 10.2 Integration Tests

**File: `apps/erp/backend/tests/integration/test_enrollment_concurrency.py`**
...
**File: `apps/erp/backend/tests/integration/test_payment_concurrency.py`**
...
**File: `apps/erp/backend/tests/integration/test_contract_activation.py`**
...
**File: `apps/erp/backend/tests/integration/test_refund_disbursement.py`**
...
**File: `apps/erp/backend/tests/load/test_enrollment.py`** (k6 or Locust)
...
**File: `apps/erp/backend/tests/load/test_payment.py`**
- 20 concurrent virtual users paying for 1 enrollment
- Verify total payments never exceed balance
- Measure response times

**File: `apps/erp/backend/tests/load/test_mixed_workload.py`**
...
- `apps/erp/backend/tests/conftest.py` — add fixtures for concurrent testing (if needed)
