...
with httpx.Client(base_url=BASE) as c:
    r = c.post('/api/v1/auth/login',
               json={'email': 'superadmin@institute.dev', 'password': 'admin123'})
    ...
    r = c.post('/api/v1/auth/login',
               json={'email': 'teacher.ee3f04@institute.dev', 'password': 'teacher123'})
    ...
    r = c.post('/api/v1/auth/login',
               json={'email': 'teacher.test@institute.dev', 'password': 'teacher123'})
