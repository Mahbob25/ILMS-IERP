"""add page_financial_records, page_staff_payroll, page_notifications permissions
...
down_revision: Union[str, None] = "202608060003"
...
def upgrade() -> None:
    ...
    permissions = [
        ("page_financial_records", "Financial Records", "Financial"),
        ("page_staff_payroll", "Staff Payroll", "Financial"),
        ("page_notifications", "Notifications", "General"),
    ]
    ...
    grant_map = {
        "page_financial_records": [MANAGER_ROLE_ID, SECRETARY_ROLE_ID],
        "page_staff_payroll": [MANAGER_ROLE_ID, SECRETARY_ROLE_ID],
        "page_notifications": [MANAGER_ROLE_ID, SECRETARY_ROLE_ID, TEACHER_ROLE_ID],
    }
...
def downgrade() -> None:
    ...
    for codename in ("page_financial_records", "page_staff_payroll", "page_notifications"):
        conn.execute(
            sa.text(
