...
- Name: section-lifecycle\cashier-dashboard.spec.ts >> Cashier Dashboard - Section Lifecycle >> cashier_views_pending_refunds
- Location: tests\e2e\section-lifecycle\cashier-dashboard.spec.ts:9:7
