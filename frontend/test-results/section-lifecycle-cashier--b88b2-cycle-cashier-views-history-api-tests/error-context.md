...
- Name: section-lifecycle\cashier-dashboard.spec.ts >> Cashier Dashboard - Section Lifecycle >> cashier_views_history
- Location: tests\e2e\section-lifecycle\cashier-dashboard.spec.ts:79:7
